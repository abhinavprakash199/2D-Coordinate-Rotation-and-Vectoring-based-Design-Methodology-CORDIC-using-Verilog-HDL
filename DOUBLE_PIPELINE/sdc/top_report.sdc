...
#  Created by Genus(TM) Synthesis Solution 20.10-p001_1 on Thu Apr 27 19:13:56 IST 2023
...
set_output_delay -clock [get_clocks clk] -add_delay 0.0002 [get_ports {ang[0]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.0002 [get_ports {ang[1]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.0002 [get_ports {ang[2]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.0002 [get_ports {ang[3]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.0002 [get_ports {ang[4]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.0002 [get_ports {ang[5]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.0002 [get_ports {ang[6]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.0002 [get_ports {ang[7]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.0002 [get_ports {ang[8]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.0002 [get_ports {ang[9]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.0002 [get_ports {ang[10]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.0002 [get_ports {ang[11]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.0002 [get_ports {ang[12]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.0002 [get_ports {ang[13]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.0002 [get_ports {ang[14]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.0002 [get_ports {ang[15]}]
